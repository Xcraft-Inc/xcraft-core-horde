...
class Slave {
  ...
  *stop (next) {
  ...
  /* TODO
   * Add routing for commands and events. The idea is that when the commander
   * or the notifier is unable to find the module requested by the command or
   * by the event, then it will use the xHorde module. Everything should be
   * transparency for the clients. It needs improvements in the BusClient in
   * order to support subscriptions, commands and events sending via xHorde.
   * It will be seen like a default gateway.
   */
}
